        ...
        <section className=" ">
            ...
            >
                <div className="space-y-4">
                    <h3 className="text-background uppercase text-3xl lg:text-5xl text-center ">
                    ...
                    <p className="text-lg lg:text-xl lg:max-w-[800px] 2xl:max-w-[900px] text-black text-center text-pretty  ">
                        We&apos;re a passionate team of web developers dedicated
                        to crafting stunning, user-friendly websites. With years
                        of experience, we specialize in crafting custom
                        websites. Let&apos;s build your digital presence
                        together.
                    </p>
                </div>
            </motion.div>
