...
const WhyUs = () => {
  ...
  return (
    <section
      style={{
        backgroundImage: "url('/images/3d5.png')",
        backgroundSize: 700,
      }}
      className="section_gap bg-no-repeat bg-contain bg-primary/10 lg:py-20  "
    >
      <div className=" container grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-10 2xl:gap-16">
        ...
        <div className=" lg:col-span-5 space-y-6 lg:space-y-8 lg:px-4 2xl:px-6">
          ...
          <p className="font-sans font-lg ">
            At our web design agency, we offer tailored solutions, expert
            designs, and a commitment to excellence, ensuring your online
            presence stands out and drives success.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 max-w-2xl">
            {whyUsQuotes?.map((ele, ind) => (
              ...
              >
                {" "}
                <Check size={18} className="fill-primary stroke-primary" />{" "}
                {ele}
              </p>
            ))}
          </div>
