...
const OurService = () => {
    ...
    return (
        <section className="section_gap space-y-8 relative ">
                    ...
                    {services.map((service, index) => (
                        ...
                        >
                            <div className="flex justify-between ">
                                <div className="  transition-all duration-500 relative ">
                                    <svg
                                        ...
                                        height="80"
                                        viewBox="0 0 200 200"
                                        className="rotate-180 absolute  top-4 left-4 group-hover:top-0 group-hover:left-0 transition-all duration-500 "
                                    >
                                        <path
                                            id="icon_25_"
                            ...
                            <div className="p-4 lg:p-8  space-y-4   ">
                                <p className="text-2xl group-hover:text-2xl tracking-wider translate-y-[150px] group-hover:translate-y-0 transition-all duration-500  ">
                                    {service?.title}
                                </p>

                                <p className="text-xl font-sans text-gray-800 text-pretty transition-all duration-500 translate-y-[500px] group-hover:translate-y-0  ">
                                    {service?.description}
                                </p>
                            </div>
                        </div>
